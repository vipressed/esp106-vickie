...
```{r question2}
air_us$outdoor_total <- air_us$pm + air_us$ozone
air_china$outdoor_total <- air_china$pm + air_china$ozone

y_max <- max(air_us$indoor, air_us$outdoor_total, air_china$indoor, airchina$outdoor_total, na.rm = TRUE)
...
```{r question3}
air_subset <- air[,c("Entity", "Year", "indoor", "pm", "ozone", "total_air")]
