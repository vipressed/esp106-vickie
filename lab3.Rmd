...
country2 <- "China" 
air_us <- air[$Entity == country1, ]
air_china <- air[air$Entity == country2, ]
names(air)
```
```
colnames(air_polution) = c("Entity","Code", "Year", "pm", "indoor", "ozone", "total_air")
colnames(gdppercapiandgini) = c("Entity", "Code", "Year", "total population", "Continent", "gini", "GDP")
```
